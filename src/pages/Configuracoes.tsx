        ...
        <div className="min-h-screen bg-linear-to-br from-zinc-100 to-zinc-200 p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8 flex items-center justify-between">
                    ...
                    <button className="bg-black text-white px-6 py-3 rounded-xl hover:opacity-90 transition-all duration-300 shadow-md">
                        Salvar Alterações
                    </button>
                </div>
                    ...
                    <div className="xl:col-span-3 space-y-6">
                        ...
                        <section className="bg-white rounded-3xl shadow-md p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <InputField label="E-mail" placeholder="john@universidade.com" />
                        ...
                        <section className="bg-white rounded-3xl shadow-md p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <InputField label="Nome da Instituição" placeholder="Universidade Alpha" />

                                <InputField label="CNPJ" placeholder="00.000.000/0001-00" />

                                <InputField label="E-mail Institucional" placeholder="contato@universidade.com" />
                            ...
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                <div>
                                    ...
                                    <p className="text-zinc-500 mt-1 text-sm">
                                        Último backup realizado em 10/05/2026 às 09:42.
                                    </p>
                                </div>

                                <div className="flex gap-3">
                                    <button className="border border-zinc-300 px-5 py-3 rounded-xl hover:bg-zinc-100 transition-all">
                                        Restaurar
                                    </button>

                                    <button className="bg-green-600 text-white px-5 py-3 rounded-xl hover:bg-green-700 transition-all shadow-md">
                                        Fazer Backup
                                    </button>
                                </div>
                            </div>
...
function MenuItem({
    ...
    return (
        <button
            className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-300 ${active
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <input
                ...
                className="border border-zinc-200 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-black transition-all"
            />
        </div>
    );
}
...
function ToggleItem({
    ...
    return (
        <div className="flex items-center justify-between border border-zinc-200 rounded-2xl p-4">
            ...
            <div
                className={`w-14 h-8 rounded-full flex items-center px-1 transition-all ${enabled ? "bg-green-500 justify-end" : "bg-zinc-300 justify-start"
                    }`}
            >
...
function ThemeCard({
    ...
    return (
        <button
            onClick={onClick}
            className={`border rounded-2xl p-6 transition-all duration-300 ${active
